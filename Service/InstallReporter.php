<?php
/**
 * Standalone install + heartbeat reporter for Panth_Testimonials.
 *
...
namespace Panth\Testimonials\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_Testimonials';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-testimonials';
